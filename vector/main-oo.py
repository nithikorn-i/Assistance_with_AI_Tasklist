...
# --- 4. สร้าง API Endpoint สำหรับการค้นหา ---
...
# ส่วนที่ใช้สำหรับรันแอปพลิเคชันด้วย Uvicorn server
# จะทำงานเมื่อรันไฟล์นี้โดยตรง (python main.py)
